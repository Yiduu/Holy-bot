...
module.exports = function userRoutes(supabase, requireAuth) {
  ...
  router.get('/my-mentor', requireAuth, async (req, res) => {
    ...
    const { data, error } = await supabase
      ...
      .select('*, mentor:mentor_id(telegram_id, anonymous_id, sex, age_range, rating, rating_count, photo_file_id, photo_updated_at, user_settings(bio, specialization, display_name, max_mentees))')
